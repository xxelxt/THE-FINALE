...
import 'package:dingtea/application/search/search_state.dart';
...
import 'package:dingtea/application/search/search_notifier.dart';
import 'package:dingtea/application/search/search_provider.dart';
              ...
              : Column(
                  children: [
                    TitleAndIcon(
                        ...
                        rightTitle:
                            "${AppHelpers.getTranslation(TrKeys.found)} ${state.shops.length} ${AppHelpers.getTranslation(TrKeys.results).toLowerCase()}"),
                    20.verticalSpace,
              ...
              : Column(
                  children: [
                    TitleAndIcon(
                        ...
                        rightTitle:
                            "${AppHelpers.getTranslation(TrKeys.found)} ${state.products.length} ${AppHelpers.getTranslation(TrKeys.results).toLowerCase()}"),
                    20.verticalSpace,

  ...
  const [columns, setColumns] = useState([
    ...
    },
    {
      ...
      render: (order_details_count) => {
        return <div className='text-lowercase'>{order_details_count || 0}</div>;
      },
    },
    {
    ...
    {
      title: t('payment.type.short'),
      dataIndex: 'transaction',
      key: 'transaction',
      is_show: true,
      render: (transaction) => t(transaction?.payment_system?.tag) || 'Tiền mặt/Ví',
    },
    {
      title: t('last.payment.status.short'),
      is_show: true,
      dataIndex: 'transaction',
      key: 'transaction',
    ...
    },
    {
      ...
      key: 'delivery_date',
      render: (_, row) => moment(row?.delivery_date).format('YYYY-MM-DD HH:mm'),
    },
    {
      title: t('options'),
      key: 'options',

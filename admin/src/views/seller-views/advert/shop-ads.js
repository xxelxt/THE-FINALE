...
export default function Advert() {
    ...
    paymentService
      ...
      .then((res) => {
        ...
        advertService
          ...
          .then(() => {
            toast.success(t('purchased.succesfully'));
          })
          .finally(() => {
            setLoading(false);
  ...
  const [columns, setColumns] = useState([
    ...
    {
      title: t('position.page'),
      dataIndex: 'position_page',
      is_show: true,
    },
    {
      title: t('expire_at'),
      dataIndex: 'expire_at',
      is_show: true,
      render: (expireDate) => moment(expireDate).format('YYYY-MM-DD hh:mm'),
    },
        ...
        return (
          <Space>
            <Button
              ...
              disabled={row.deleted_at || row.transaction?.status === 'paid'}
              loading={loading}
            >
              {t('purchase')}
            </Button>
